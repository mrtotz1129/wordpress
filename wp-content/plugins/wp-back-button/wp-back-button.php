...
class XM_WPBB {
    ...
    public function wp_back_button(){
        ...
        if((is_single() || is_page() || is_post_type_archive()) && !$options['disableBoton'] ) { ?>
            ...
            <div class="backButton <?php echo $posicionBoton; ?> <?php if($options['displayBoton']){echo 'forceShow';} ?> <?php if(!$options['transitionBoton']){echo 'transition';} ?>" style="display:block">
                 <a href="<?php echo $backbuttonurl; ?>" title="<?php echo $textoBoton; ?>"><span class="simbolo"></span><span class="texto"><?php echo $textoBoton; ?></span></a>
            </div>
